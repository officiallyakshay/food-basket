...
Geocode.setApiKey("AIzaSyDl6NClnt601rlaqaGeTdPU_XSZtYNWd2o");
...
class NeedHelp extends React.Component {
  ...
  handleSearch(event) {
    this.setState(this.state.term, this.state.latitude,this.state.longitude, this.state.number);
 ...
 GoodJob(value) {
  ...
  render() {
    console.log(this.state.term, this.state.latitude, this.state.longitude, 'hiiiiii');
